...
import com.kipa.mybatis.dao.mapper1.DatabaseInfoMapper1;
...
public class TypeHelper1 {
    ...
    public String getColumnType(String tableName, String columnName) {
        final List<Map<String, Object>> list = databaseInfoMapper1.listTableColumn(tableName);
